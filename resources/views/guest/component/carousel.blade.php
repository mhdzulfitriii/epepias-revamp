<div id="auto-play" data-carousel='{ "loadingClasses": "opacity-0", "isAutoPlay": true, "speed": 5000, "dotsItemClasses": "carousel-dot" }' class="relative m-10" >
    <div class="carousel h-[500px]">
