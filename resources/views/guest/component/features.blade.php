...
<div class="w-full bg-white mt-10">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="aspect-w-16 aspect-h-7">
            <img class="w-full object-cover rounded-xl h-[500px]"
        ...
        <div class="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
            <div class="lg:col-span-1">
                ...
                <p class="mt-2 md:mt-4 text-gray-500">
                    Persatuan Pelajar Islam Selangor Darul Ehsan, PEPIAS merupakan salah satu badan bukan kerajaan yang membawa mesej Islamiyah dan beroperasi di Selangor
                </p>
            </div>
            <!-- End Col -->
