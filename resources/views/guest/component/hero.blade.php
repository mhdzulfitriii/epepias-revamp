    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-5 relative text-center">
        <div class="border border-indigo-600 p-1 w-60 mx-auto rounded-full flex items-center justify-between mb-4">
            <span class="font-inter text-xs font-medium text-gray-900 ml-3">epepias.org.</span>
        ...
        <div class="max-sm:hidden">
            @include('guest.component.carousel')
        </div>
        <a href="javascript:;"
