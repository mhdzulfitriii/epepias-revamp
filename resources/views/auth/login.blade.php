    ...
    <div class="relative bg-gradient-to-bl from-blue-100 via-transparent">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div>
                    ...
                    <div class="mt-4 md:mb-12 max-w-2xl">
                        <h1 class="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-gray-200">
                            Sistem Pengurusan Keahlian dan Program PEPIAS
                        </h1>
                        {{-- <p class="text-gray-600 dark:text-gray-400">
                            Menyediakan kemudahan kepada Badan Gabungan Negeri, PKPIM Negeri, PKPIM Kampus sebagai pusat
                    ...
                    <blockquote class="hidden md:block relative max-w-sm">
                        ...
                        <div class="relative z-10">
                            <p class="text-xl italic font-extrabold text-gray-800 dark:text-white">
                                Generasi Penerus Harapan Ummah
                            </p>
                        </div>
                        ...
                        <div class="lg:max-w-md lg:mx-auto lg:me-0 ms-auto">
                            ...
                            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-slate-900">
                                <div class="text-center">
                                    <img src="{{ asset('PEPIAS.png') }}" alt=""
                                        class="w-[100px] h-auto mx-auto mt-8">
                                    <h1 class="block text-2xl mt-3 font-bold text-gray-800 dark:text-white">Log Masuk</h1>
                                </div>

                                <div class="mt-3">
                                    <div class="mb-5">
                                        <a href="/admin/login" type="button"
                                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gray-800 text-white hover:bg-black disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                    ...
                                    <div class="grid gap-y-4 ">
                                        ...
                                        <p class=" text-sm text-center">Daftar Keahlian ? <a
                                                ...
                                                href="/daftar/informasi-keahlian">Daftar segera</a></p>
                                    </div>
                                    <!-- End Grid -->
                                </div>
                            </div>
            ...
            {{-- <div
                ...
                Antara PKPIM Negeri, Kampus dan Badan Gabungan Negeri kami.
            </div>
